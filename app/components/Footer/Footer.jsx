...
import { FaGlobe, FaDollarSign, FaFacebook, FaTwitter, FaInstagram } from "react-icons/fa";
            ...
            <div className="max-w-[1400px] mx-auto px-4 py-12 md:py-16">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
                    <div>
                        {/* Logo/Logo Graphic */}
                        <div className="mb-4 ">
                            <img src="/images/logo.png" alt="ITJobNow" className="w-60 h-full" />
                        </div>
                        {/* Description */}
                    ...
                    <div>
                        <Link href="/contact" className="text-lg font-bold text-gray-900 mb-4 hover:text-primary transition-colors block">
                            Contact Us
                        </Link>
